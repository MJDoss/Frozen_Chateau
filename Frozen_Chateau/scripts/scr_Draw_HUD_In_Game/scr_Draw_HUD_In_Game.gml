...
function Draw_In_Game_HUD(){
	...
	if(global.PlayerData.max_HP == 60) draw_sprite_ext(spr_GUI_health_bar_60,0,8*global.settings.winscale,8*global.settings.winscale,global.settings.winscale,global.settings.winscale,0,-1,1);
	if(global.PlayerData.max_HP == 80) draw_sprite_ext(spr_GUI_health_bar_80,0,8*global.settings.winscale,8*global.settings.winscale,global.settings.winscale,global.settings.winscale,0,-1,1);
